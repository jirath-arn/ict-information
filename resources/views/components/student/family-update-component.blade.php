...
<table class="table table_borderless w-full">
    <tbody>
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="father_first_name_th" name="father_first_name_th" type="text" class="form-control @error('father_first_name_th') is-invalid @enderror" value="{{ old('father_first_name_th', $info->father_first_name_th ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="father_last_name_th" name="father_last_name_th" type="text" class="form-control @error('father_last_name_th') is-invalid @enderror" value="{{ old('father_last_name_th', $info->father_last_name_th ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="father_first_name_en" name="father_first_name_en" type="text" class="form-control @error('father_first_name_en') is-invalid @enderror" value="{{ old('father_first_name_en', $info->father_first_name_en ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="father_last_name_en" name="father_last_name_en" type="text" class="form-control @error('father_last_name_en') is-invalid @enderror" value="{{ old('father_last_name_en', $info->father_last_name_en ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="mother_first_name_th" name="mother_first_name_th" type="text" class="form-control @error('mother_first_name_th') is-invalid @enderror" value="{{ old('mother_first_name_th', $info->mother_first_name_th ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="mother_last_name_th" name="mother_last_name_th" type="text" class="form-control @error('mother_last_name_th') is-invalid @enderror" value="{{ old('mother_last_name_th', $info->mother_last_name_th ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="mother_first_name_en" name="mother_first_name_en" type="text" class="form-control @error('mother_first_name_en') is-invalid @enderror" value="{{ old('mother_first_name_en', $info->mother_first_name_en ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="mother_last_name_en" name="mother_last_name_en" type="text" class="form-control @error('mother_last_name_en') is-invalid @enderror" value="{{ old('mother_last_name_en', $info->mother_last_name_en ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="relative_first_name_th" name="relative_first_name_th" type="text" class="form-control @error('relative_first_name_th') is-invalid @enderror" value="{{ old('relative_first_name_th', $info->relative_first_name_th ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="relative_last_name_th" name="relative_last_name_th" type="text" class="form-control @error('relative_last_name_th') is-invalid @enderror" value="{{ old('relative_last_name_th', $info->relative_last_name_th ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="relative_first_name_en" name="relative_first_name_en" type="text" class="form-control @error('relative_first_name_en') is-invalid @enderror" value="{{ old('relative_first_name_en', $info->relative_first_name_en ?? '') }}" maxlength="50" required />
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="relative_last_name_en" name="relative_last_name_en" type="text" class="form-control @error('relative_last_name_en') is-invalid @enderror" value="{{ old('relative_last_name_en', $info->relative_last_name_en ?? '') }}" maxlength="50" required />
