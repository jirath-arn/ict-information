...
<table class="table table_borderless w-full">
    <tbody>
        <tr>
            ...
            <td class="w-3/4 text-left">
                <div class="custom-select">
                    <select id="education" name="education" class="form-control @error('education') is-invalid @enderror" autofocus>
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="name_school" name="name_school" type="text" class="form-control @error('name_school') is-invalid @enderror" value="{{ old('name_school', $info->name_school ?? '') }}" />
                @error('name_school')
                    <small class="block mt-2 invalid-feedback">
                        {{ $message }}
                    </small>
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="qualification" name="qualification" type="text" class="form-control @error('qualification') is-invalid @enderror" value="{{ old('qualification', $info->qualification ?? '') }}" />
                @error('qualification')
                    <small class="block mt-2 invalid-feedback">
                        {{ $message }}
                    </small>
        ...
        <tr>
            ...
            <td class="text-left">
                <div class="custom-select">
                    <select id="graduate_year" name="graduate_year" class="form-control @error('graduate_year') is-invalid @enderror">
                        <option>ตัวเลือก...</option>
        ...
        <tr>
            ...
            <td class="text-left">
                <input id="gpa" name="gpa" type="number" class="form-control @error('gpa') is-invalid @enderror" min="0" max="4" step="0.01" value="{{ old('gpa', $info->gpa ?? 0) }}" />
                @error('gpa')
                    <small class="block mt-2 invalid-feedback">
                        {{ $message }}
                    </small>
